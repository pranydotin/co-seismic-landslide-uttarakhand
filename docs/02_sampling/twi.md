# Topographic Wetness Index (TWI) — Frequency Ratio Classification
...
- **Formula:** TWI = ln(a / tan β), where *a* = specific catchment area, *β* = slope angle
